...
def process_first_answer(message, task_id, topic, question, level, bot):
    ...
    try:
        ...
        bot.register_next_step_handler(message, process_second_answer, task_id, topic, question,
...
def process_look_at_added_test_task(message, task_id, topic, question,
    ...
    try:
        ...
        if message.text in ("Continue", "cancel"):
            ...
            # Ask the user for the test_task topic
            bot.send_message(chat_id, f"{task_id}, {topic}, {question}, {first_answer}, {second_answer}, "
